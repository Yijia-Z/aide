...
export function LoginForm() {
  ...
  const handleCredentials = async (e: React.FormEvent, mode: 'login' | 'register') => {
    e.preventDefault()
    setIsLoading(true)
    setError(null)
    ...
    try {
      const result = await signIn("credentials", {
        email,
        password,
        mode, // Pass mode to backend to distinguish between login and register
        redirect: false,
      })
        ...
        <CardContent>
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <form onSubmit={(e) => handleCredentials(e, 'login')} className="grid gap-4">
            ...
            <TabsContent value="register">
              <form onSubmit={(e) => handleCredentials(e, 'register')} className="grid gap-4">
                <div className="grid gap-2">
