...
import { CreateToolDialog} from "@/components/ui/CreateToolDialog";
import { ScriptEditorDialog } from "./ui/ScriptSandboxDialog";
import { upsertNewTool,saveToolScript,handleUploadScript } from "@/lib/frontapi/toolApis";
    ...
    if (apiBaseUrl) {
      ...
      try {
        ...
        for (const tool of data.tools) {
          const localScript = window.localStorage.getItem(`script_${tool.id}`);
          if (localScript) {
            // setToolScripts
            setToolScripts(prev => ({
              ...prev,
